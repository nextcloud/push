...
class ConfigService {
	...
	const DEBUG = 'debug';
	const DELAY_POLLING = 'delay_polling';
	const TYPE_POLLING = 'type_polling';

	const POLLING_TYPE_SHORT = 'short';
	const POLLING_TYPE_LONG = 'long';
	const POLLING_TYPE_NODEJS = 'nodejs';


	public $defaults = [
		self::DEBUG         => '0',
		self::DELAY_POLLING => '5',
		self::TYPE_POLLING  => self::POLLING_TYPE_SHORT
	];
	 ...
	 * @return bool
	 */
	public function isPollingType(string $type): bool {
		if ($this->getAppValue(self::TYPE_POLLING) === $type) {
			return true;
		}
